# Generated by Django 3.0.5 on 2020-10-05 22:01
...
class Migration(migrations.Migration):
    ...
    dependencies = [
        ('measuremeterdata', '0053_country_has_measures'),
    ]
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('updated', models.DateTimeField(auto_now=True)),
                ('name', models.CharField(max_length=200)),
                ('name_source', models.CharField(blank=True, max_length=3, null=True)),
                ('population', models.IntegerField(default=1)),
            ],
            options={
                'abstract': False,
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('province', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='measuremeterdata.BELProvince')),
            ],
            options={
                'abstract': False,
            },
