...
def calc_ranking_countries(countries):
    ...
    for country in countries:
        ...
        if country.pk != 11:
            ...
            try:
                score = float(cases[0].cases_past14days) + float(cases[0].cases_past7days) + (float(cases[0].development7to7) * float(cases[0].cases_past7days) /100) + (float(last_positivity_calc) * float(cases[0].cases_past7days) / 25) + float((cases[0].deaths_past14days * 20))
                score_7days_before = float(case_14days_7daysago.cases_past14days) + float(case_14days_7daysago.cases_past7days) + (float(case_14days_7daysago.development7to7) * float(case_14days_7daysago.cases_past7days) /100) + (float(positivity_before7) * float(case_14days_7daysago.cases_past7days) / 25) + float((case_14days_7daysago.deaths_past14days * 20))
                ...
                print(f"pos: {(float(last_positivity_calc) * float(cases[0].cases_past7days))/25}")
