    ...
    def handle(self, *args, **options):
        ...
        for cases in CHCases.objects.filter(canton=40).order_by('date'):
            if (cases.date < start_so):
                saveit(141, cases.cases_past14days, cases.date)
                saveit(142, cases.cases_past14days, cases.date)
                saveit(143, cases.cases_past14days, cases.date)
                saveit(144, cases.cases_past14days, cases.date)
                saveit(145, cases.cases_past14days, cases.date)
                saveit(146, cases.cases_past14days, cases.date)
                saveit(147, cases.cases_past14days, cases.date)
                saveit(148, cases.cases_past14days, cases.date)
                saveit(149, cases.cases_past14days, cases.date)
                saveit(150, cases.cases_past14days, cases.date)
