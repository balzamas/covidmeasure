...
class CasesDeathsSerializer(serializers.ModelSerializer):
    ...
    class Meta:
        model = CasesDeaths
        fields = ['pk', 'country', 'date', 'deaths', 'cases', 'deathstotal', 'deaths_past14days', 'deaths_past7days','cases_past14days', 'cases_past7days', 'positivity', 'development7to7', 'r0peak', 'r0low', 'r0median', 'tests', 'tests_smoothed_per_thousand']
