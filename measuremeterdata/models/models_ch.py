...
class DoomsdayClock(MotherModel):
    ...
    r6_value = models.DecimalField(max_digits=50, decimal_places=2, null=True, blank=True)
    r6_date = models.DateField(null=True, blank=True)
    r7_value = models.DecimalField(max_digits=50, decimal_places=2, null=True, blank=True)
    ...
    hosp2_date = models.DateField(null=True,blank=True)
    hosp3_value = models.DecimalField(max_digits=50, decimal_places=2, null=True, blank=True)
    hosp3_date = models.DateField(null=True,blank=True)
    hosp4_value = models.DecimalField(max_digits=50, decimal_places=2, null=True, blank=True)
    hosp4_date = models.DateField(null=True,blank=True)
    hosp5_value = models.DecimalField(max_digits=50, decimal_places=2, null=True, blank=True)
    hosp5_date = models.DateField(null=True,blank=True)
    hosp6_value = models.DecimalField(max_digits=50, decimal_places=2, null=True, blank=True)
    hosp6_date = models.DateField(null=True, blank=True)
    hosp7_value = models.DecimalField(max_digits=50, decimal_places=2, null=True, blank=True)
...
class CHDeaths(MotherModel):
    ...
    deaths22 = models.IntegerField(null=True,blank=True)
