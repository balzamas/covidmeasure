...
class CasesDeathResource(resources.ModelResource):
    class Meta:
        model = CasesDeaths
        fields = ('country__name', 'country__code','country__iso_code', 'country__continent', 'date', 'cases', 'deaths', 'cases_past14days', 'deaths_past14days', 'development7to7', 'r0median', 'hosp_per_million', 'people_vaccinated_per_hundred', 'tests_smoothed_per_thousand', 'positivity')
