...
from measuremeterdata.views import view_deaths, view_deaths_ch,views_belgium, views_ranking_ch, views_ranking_int, viewsets, view_madlaina, view_measures_ch, doomsdayclock, view_world_measures, closeometer
...
urlpatterns += i18n_patterns(
    ...
    path(
        "closeometer/", closeometer.load_data, name="Close-o-meter"
    ),
    path(
    ...
    path('measures_int/', view_world_measures.measures_noparam, name='measures_int'),
    path('measures_int/<str:countries>/<str:measuretypes>/', view_world_measures.measures_ch, name='measures_int'),
    path(
