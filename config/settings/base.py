...
# measuremeter/)
APPS_DIR = ROOT_DIR / "measuremeter"
env = environ.Env()
...
MIGRATION_MODULES = {"sites": "measuremeter.contrib.sites.migrations"}
...
TEMPLATES = [
    {
        ...
        "OPTIONS": {
            ...
            "context_processors": [
                ...
                "measuremeter.utils.context_processors.settings_context",
            ],
        },
    }
]
...
ADMINS = [("""David Berger""", "d.berger@dontsniff.co.uk")]
...
# https://django-allauth.readthedocs.io/en/latest/configuration.html
ACCOUNT_ADAPTER = "measuremeter.users.adapters.AccountAdapter"
# https://django-allauth.readthedocs.io/en/latest/configuration.html
SOCIALACCOUNT_ADAPTER = "measuremeter.users.adapters.SocialAccountAdapter"
...
TWITTER_IMPF_API_KEY = env("TWITTER_IMPF_API_KEY")
TWITTER_IMPF_SECRET_KEY = env("TWITTER_IMPF_SECRET_KEY")
TWITTER_IMPF_ACCESS_TOKEN = env("TWITTER_IMPF_ACCESS_TOKEN")
TWITTER_IMPF_ACCESS_TOKEN_SECRET = env("TWITTER_IMPF_ACCESS_TOKEN_SECRET")

TWITTER_PHOTO_API_KEY = env("TWITTER_PHOTO_API_KEY")
TWITTER_PHOTO_SECRET_KEY = env("TWITTER_PHOTO_SECRET_KEY")
TWITTER_PHOTO_ACCESS_TOKEN = env("TWITTER_PHOTO_ACCESS_TOKEN")
TWITTER_PHOTO_ACCESS_TOKEN_SECRET = env("TWITTER_PHOTO_ACCESS_TOKEN_SECRET")
